 ...
 *
 *    Description:  structures to maSTUB_INTain database information, at a particular time only one database will be active
...
//Structure for dtoring database information , like db poSTUB_INTer, database name and path(location) of the database in local machine.
